...
class LayersTest(GeoNodeBaseTestSupport):
    ...
    def test_layer_bbox(self):
        ...
        self.assertEqual(lyr.ll_bbox, [-180.0, 180.0, -90.0, 90.0, u'EPSG:4326'])
        projected_bbox = decimal_encode(
            bbox_to_projection([float(coord) for coord in layer_bbox] + [lyr.srid, ],
                               target_srid=3857)[:4])
        logger.info(projected_bbox)
    ...
    def test_get_files(self):
        ...
        try:
            ...
            self.assertEqual(gotten_files, dict(shp="foo.shp", shx="foo.shx",
    ...
    def test_get_valid_name(self):
        ...
        self.assertEqual(get_valid_name("CA"), "CA_1")
        self.assertEqual(get_valid_name("CA"), "CA_1")
    ...
    def test_get_valid_layer_name(self):
        ...
        self.assertEqual(get_valid_layer_name("CA", False), "CA_1")
        self.assertEqual(get_valid_layer_name("CA", False), "CA_1")
        self.assertEqual(get_valid_layer_name("CA", True), "CA")
        self.assertEqual(get_valid_layer_name("CA", True), "CA")

        layer = Layer.objects.get(name="CA")
        self.assertEqual(get_valid_layer_name(layer, False), "CA_1")
