...
class MapNotesTest(TestCase):
    ...
    def test_get_notes_map(self):
        ...
        self.assertEqual(2, len(note_json["features"]))
        ...
        note_json = json.loads(response.content)
        self.assertEqual(1, len(note_json["features"]))
        for feature in note_json["features"]:
    ...
    def test_get_notes_bbox(self):
        ...
        note_json = json.loads(response.content)
        self.assertEqual(0, len(note_json["features"]))
    ...
    def test_get_specific_note(self):
        ...
        note_json = json.loads(response.content)
        self.assertEqual(1, len(note_json["features"]))
        self.assertEqual(2, note_json["features"][0]["id"])
        self.assertEqual("Map Note 2", note_json["features"][0]["properties"]["title"])
    ...
    def test_create_new_note(self):
        ...
        note_json = json.loads(response.content)
        self.assertEqual(1, len(note_json["features"]))
        self.assertEqual(4, note_json["features"][0]["id"])
        self.assertEqual([0.08789062499998361, 17.81145608856474], note_json["features"][0]["geometry"]["coordinates"])
        self.assertEqual("This is my new note", note_json["features"][0]["properties"]["content"])
    ...
    def test_modify_existing_note(self):
        ...
        note_json = json.loads(response.content)
        self.assertEqual(1, len(note_json["features"]))
        self.assertEqual(1, note_json["features"][0]["id"])
        self.assertEqual([0.38789062499998361, 23.81145608856474], note_json["features"][0]["geometry"]["coordinates"])
        self.assertEqual("This is my new note, modified", note_json["features"][0]["properties"]["content"])
        self.assertEqual("A modified note", note_json["features"][0]["properties"]["title"])
